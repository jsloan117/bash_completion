...
_kitchen_options () {
  ...
  case $prev in
    converge|create|destroy|diagnose|exec|list|login|package|setup|test|verify)
    ...
    driver)
      ...
      ;;
    *)
      COMPREPLY=( $(compgen -W "console converge create destroy diagnose driver exec help init list login package setup test verify version"  -- ${cur} ))
      return 0
      ;;
  esac
}
